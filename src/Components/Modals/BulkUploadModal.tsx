...
export default function BulkUploadModal({ openModal, closeModal, title }) {
        ...
        >
          ...
          <div>
            ...
            <div className="flex flex-col gap-y-10">
              ...
              <p>Step 5: Click on the “Upload csv file” button to upload</p>
              <Button
                variant="contained"
                type="submit"
                color="tertiary"
