...
export default function ParentBiodata({ data }) {
  ...
  return (
    <div className="mb-14 flex flex-col gap-y-9 w-full max-w-[925px]">
      <div className="flex flex-col md:flex-row justify-between items-center gap-y-9 md:gap-x-[119px] md:gap-y-0">
        ...
        <CustomReviewData label="Surname" value={parentData?.parent_surname} />
      </div>
      <div className="flex flex-col md:flex-row justify-between items-center gap-y-9 md:gap-x-[119px] md:gap-y-0">
        <CustomReviewData
          label="First name"
      ...
      <CustomReviewData label="Relationship" value={parentData?.relationship} />
      <CustomReviewData
        label="Home address"
